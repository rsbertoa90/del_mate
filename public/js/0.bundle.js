...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__categories_vue__ = __webpack_require__(214);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_vue__ = __webpack_require__(219);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__products_vue__ = __webpack_require__(222);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        toggle_hide_prices: function toggle_hide_prices() {
            this.configs.hide_prices = !this.configs.hide_prices;
            var numeric = this.configs.hide_prices ? 1 : 0;
            var data = {
                field: 'hide_prices',
                value: numeric
            };
    ...
    methods: {
        bindFile: function bindFile(e) {
            ...
            if (ext == 'png' || ext == 'jpg' || ext == 'jpeg' || ext == 'gif' || ext == webp) {
                ...
                this.$http.post('/admin/categories/image', fileUploadFormData).then(function (response) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("cb4cfbac", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Product_row_vue__ = __webpack_require__(226);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__admin_paginator_vue__ = __webpack_require__(137);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("068365c3", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
  ...
  return _c("div", { staticClass: "row mt-4 p-4" }, [
    ...
    _vm.configs
      ? _c("div", { staticClass: "col-12 row" }, [
          ...
          _vm.configs
            ? _c("div", { staticClass: "col-12" }, [
                _vm.configs.hide_prices
                  ? _c(
                      "button",
                      {
                        staticClass: "btn btn-outline-info",
                        on: { click: _vm.toggle_hide_prices }
                      },
                      [
                        _vm._v(
                          "\n                Mostrar precios\n            "
